...
return [cljs.core.str(p1__5470_SHARP_),cljs.core.str(cljs.core.rand_nth.call(null,char_set))].join('');
});})(char_set,length))
,"",length);
});})(char_set,length))
;
...
var G__5471 = generate_candidate.call(null);
candidate = G__5471;
continue;
} else {
return candidate;
...
return staplo.common.accumulate.call(null,(function (p1__5472_SHARP_){
return cljs.core.conj.call(null,p1__5472_SHARP_,staplo.common.rand2.call(null,(3),(9)));
...
while(true){
var map__5475 = candidate_op;
var map__5475__$1 = ((cljs.core.seq_QMARK_.call(null,map__5475))?cljs.core.apply.call(null,cljs.core.hash_map,map__5475):map__5475);
var map__5476 = cljs.core.get.call(null,map__5475__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var map__5476__$1 = ((cljs.core.seq_QMARK_.call(null,map__5476))?cljs.core.apply.call(null,cljs.core.hash_map,map__5476):map__5476);
var precondition = cljs.core.get.call(null,map__5476__$1,new cljs.core.Keyword(null,"precondition","precondition",-1794440545));
var operation = cljs.core.get.call(null,map__5476__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
...
var G__5477 = rand_op.call(null);
candidate_op = G__5477;
continue;
}
break;
}
...
var step = (function step(p__5493){
var map__5496 = p__5493;
var map__5496__$1 = ((cljs.core.seq_QMARK_.call(null,map__5496))?cljs.core.apply.call(null,cljs.core.hash_map,map__5496):map__5496);
var text = cljs.core.get.call(null,map__5496__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var op_history = cljs.core.get.call(null,map__5496__$1,new cljs.core.Keyword(null,"op-history","op-history",-1175310787));
var text_history = cljs.core.get.call(null,map__5496__$1,new cljs.core.Keyword(null,"text-history","text-history",1517872421));
var op_sort = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(operations_config);
var map__5497 = staplo.generator.generate_op.call(null,staplo.operations.operations.call(null,op_sort),new cljs.core.Keyword(null,"list","list",765357683).cljs$core$IFn$_invoke$arity$1(operations_config),text,op_history,text_history);
var map__5497__$1 = ((cljs.core.seq_QMARK_.call(null,map__5497))?cljs.core.apply.call(null,cljs.core.hash_map,map__5497):map__5497);
var op_name = cljs.core.get.call(null,map__5497__$1,new cljs.core.Keyword(null,"op-name","op-name",854688697));
var op = cljs.core.get.call(null,map__5497__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
